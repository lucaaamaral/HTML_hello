...
function update()
{
    ...
    //OBJETIVO: colocar tipo input dentro das celulas
        ...
        /*
        //Acreduito que não mais necessario
        cell0.id = i+"_"+0;
        cell1.id = i+"_"+1
        cell2.id = i+"_"+2
        cell3.id = i+"_"+3
...
function envia()
{
	...
	//window.localStorage.requisition -=1;
	document.getElementById("ver").innerHTML = window.localStorage.requisition;
	return true;
}
